# bytepushers-js-restful
Core Restful JavaScript framework.

## Synopsis

Byte Pushers JavaScript Restful library that supports core restful features for processing RESTful response and request.
